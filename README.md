...
| 로비 (메인 화면) | 스테이지 선택 |
| :---: | :---: |
| ![로비](./메인페이지.gif) | ![스테이지 선택](./스테이지 선택.gif) |
...
| :---: | :---: | :---: |
| ![1980년대 스테이지](./1980게임.gif) | ![2000년대 스테이지](./2000게임.gif) | ![2020년대 스테이지](./2020게임.gif) |
...
| :---: | :---: | :---: | :---: |
| ![장애물 피격](./부딪혔을때.gif) | ![돌발 퀴즈](./퀴즈.gif) | ![보호막 및 부스트](./퀴즈 정답 후 방어막.gif) | ![게임 오버](./게임오버.gif) |
...
| :---: | :---: | :---: |
| ![금융 상품 선택](./금융 상품 선택 후 결과.gif) | ![상점 구매](./상점.gif) | ![UFO 정비](./UFO 정비.gif) |
